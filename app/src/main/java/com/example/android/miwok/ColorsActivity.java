...
public class ColorsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView colorList = findViewById(R.id.list);

        WordAdapter colorListAdapter = new WordAdapter(this, colors, R.color.category_colors);
        ...
        colorList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (result == AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
                    ...
                    colorSoundPlayer = MediaPlayer.create(ColorsActivity.this, color.getSoundID());
                    colorSoundPlayer.start();
