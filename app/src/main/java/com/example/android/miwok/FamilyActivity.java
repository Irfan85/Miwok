...
public class FamilyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView familyList = findViewById(R.id.list);

        WordAdapter familyListAdapter = new WordAdapter(this, familyMembers, R.color.category_family);
        ...
        familyList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (result == AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
                    ...
                    familySoundPlayer = MediaPlayer.create(FamilyActivity.this, familyMember.getSoundID());
                    familySoundPlayer.start();
