...
public class PhrasesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView phraseList = findViewById(R.id.list);

        WordAdapter phraseListAdapter = new WordAdapter(this, phrases, R.color.category_phrases);
        ...
        phraseList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (result == AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
                    ...
                    phraseSoundPlayer = MediaPlayer.create(PhrasesActivity.this, phrase.getSoundID());
                    phraseSoundPlayer.start();
